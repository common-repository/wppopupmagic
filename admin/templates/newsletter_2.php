...
<div class='wppum_newsletter theme_<?= $popup["newsletter_template"] ?>'>
    ...
    <form id='wppum_nl_form' action='#' class='wppum_nl_form'>
        <div class="form-center-half">

            <div class="row">
                <div class="col-md-12 text-center">
                    <img class="newsletter_logo" src="<?=$popup['newsletter_logo']!=""?$popup['newsletter_logo']: WPPUM__POPUP_URL . "/images/newsletter2logo.png" ?>" class="responsive"/>
                    <?php
                    if ($popup["newsletter_heading"] != "") {
                        ?>
                        <h4><?= $popup["newsletter_heading"] ?></h4>
                        <?php
                    }
                    ?>
                    <?php
                    if ($popup["newsletter_sub_heading"] != "") {
                        ?>
                        <h5><?= $popup["newsletter_sub_heading"] ?></h5>
                        <?php
                    }
                    ?>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input class="wppum_nl_email" name="wppum_nl_email" required id="wppum_nl_email"  class="form-control" placeholder="<?= $popup['newsletter_email_placeholder'] ?>"/>
                </div>
